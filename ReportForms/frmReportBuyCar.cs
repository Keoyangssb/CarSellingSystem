...
{
    public partial class frmReportBuyCar : Form
    {
        public frmReportBuyCar()
        {
            InitializeComponent();
        }
        private myClass db = new myClass();
        private void frmReportBuyCar_Load(object sender, EventArgs e)
        {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(globalVariable.connectionString))
            {
                ...
                string sql = "SELECT *,N'" + from_date_to_date + "' as from_date_to_date FROM v_buy_car ";
